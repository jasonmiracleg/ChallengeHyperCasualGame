...
struct Particles {
    static func createDustEmitter() -> SKEmitterNode {
        ...
        emitter.particleBirthRate = 10 // Number of particles created per second
        emitter.numParticlesToEmit = 15 // The total number of particles to create before stopping.
        emitter.particleLifetime = 0.3 // How long each particle stays alive (in seconds).
        ...
        emitter.particleScale = 0.05 // Initial size scale of the particle relative to its texture.
        emitter.particleScaleRange = 0.05 // Random variation for size.
        emitter.particleScaleSpeed = -0.2 // How much the particle shrinks or grows per second.
